...
def build_agent_prompt(
    ...
    return (
        ...
        "Discord formatting: do not use Markdown tables in Discord replies. "
        "Discord renders pipe tables poorly, especially on mobile. Use bullets, "
        "numbered lists, or short labeled sections instead.\n"
